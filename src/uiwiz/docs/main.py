...
from uiwiz.docs.layout import Layout, Page, pages
from uiwiz.docs.page_docs import docs_router
...
@asynccontextmanager
async def lifespan(app: UiwizApp) -> AsyncGenerator[None]:
...
async def not_found_exception_handler(request: Request, exc: Exception) -> HTMLResponse:
